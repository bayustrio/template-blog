...
const CardHome = () => {
  return (
    <>
      <div className="flex md:px-5 px-5 xl:flex-row flex-col lg:flex-row md:flex-row sm:flex-row justify-center gap-3 flex-nowrap items-center md:flex-wrap sm:flex-wrap lg:flex-wrap xl:flex-wrap">
        {Data.map((item, idx) => (
          <div
            className="xl:w-[30%]   lg:w-[30%] md:w-[45%] sm:w-[45%] w-full"
            key={idx}
          >
            {/* <img src={item["logo "]} /> */}
            <div className="bg-white relative  rounded-lg max-w-sm mb-5">
              ...
              <div className="p-5">
                ...
                <p className="font-normal xl:text-left lg:text-left md:text-left sm:text-left mt-2 text-gray-700 mb-3">
                  {item.description}
                </p>
                <a
